                            ...
                            <form size='large' className="form-horizontal">
                                <div className="row">
                                    ...
                                    <div className="col-xs-12 col-sm-12 col-md-3">
                                        <div className="dashboardBox">
                                            <span className="dashboardText"> Open </span>
                                            <div className="dashboardText"> <b>REDEEM REQUESTS</b></div>
                                            <div className="dashboardCountText">{this.props.initialValues !== undefined ? (this.props.initialValues.responseData ? this.props.initialValues.responseData.openRedeemRequestsCount : "0") : "0"}</div>
                                            <div><hr className="dashboardLine"/></div>
                                        </div>
                                    </div>
                                    <div className="col-xs-12 col-sm-12 col-md-3">
                    ...
                    <div className="col-xs-12 col-sm-6 col-md-6">
                        <span>Redeem Requests</span>
                        {
                            this.props.initialValues ?
                                (
                                    this.props.initialValues.responseData ?
                                        <Pie data={this.props.initialValues.responseData.redeemRequests} />
                                    :   null
                                )
                            :   null
                        }
...
const mapDispatchToProps = (dispatch) => {
  ...
  export default reduxForm({form: 'FrmSuperAdminDashboard'})(superAdminDashboard)