            ...
            <div className="row">
                <div className="col-xs-12">
                    <Paper className="pagePaper">
                        ...
                        <div className="row middle-md">
                            <div className="col-md-12">
                                Start processing with us to start boosting your sales. Our processing application takes under 5 minutes, and you typically get approved within 10 minutes.
                            </div>    
                        </div>
